        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FaveoriteId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tutorials_MaintenanceServices_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_MaintenanceServices_ServicesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Faveorites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Faveorites_Users_UserId",
                        column: x => x.UserId,
                        principalSchema: "Security",
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AvaliableDates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AvaliableDates_Bookings_BookingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FaveoriteItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FaveoriteItems_Faveorites_FavoriteId",
                        column: x => x.FavoriteId,
                        principalTable: "Faveorites",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FaveoriteItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvaliableDates_BookingId",
                table: "AvaliableDates",
                column: "BookingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FaveoriteItems_FavoriteId",
                table: "FaveoriteItems",
                column: "FavoriteId");

            migrationBuilder.CreateIndex(
                name: "IX_FaveoriteItems_ProductId",
                table: "FaveoriteItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Faveorites_UserId",
                table: "Faveorites",
                column: "UserId",
                unique: true);
